...
주요: `/clear`, `/compact`, `/context`, `/model`, `/resume`, `/mcp`, `/export`, `/output-style`, `/memory`, `/agents`
...
- **Hooks** — 라이프사이클 훅. `![[스크린샷 2026-04-19 오전 10.02.48.png]]` `![[스크린샷 2026-04-19 오전 10.03.32.png]]`
- **Agent Teams** — 다중 에이전트 조직화. `![[스크린샷 2026-04-17 오후 6.32.40.png]]`
