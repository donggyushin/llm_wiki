...
[[entities/matt-pocock]] 는 [[sources/matt-pocock-software-fundamentals]] 에서 기본 plan mode 의 한 가지 실패 모드를 지적한다:

> *"Plan mode is extremely eager to create an asset. It really wants to create a plan and start working."*

문제: AI 와 사용자 사이의 [[concepts/design-concept]] 합의가 충분히 이루어지기 전에 plan.md 라는 *자산* 이 먼저 만들어진다. 자산이 박제되면 그 위로 합의를 만든 *척* 진행되기 쉽다.

처방: plan mode 진입 전에 **grill me** 같은 스킬로 design concept 합의 → 그 결과를 plan mode 의 입력으로. 또는 plan 자산을 *적극 편집* (위 [[#플랜을-그냥-수락하지-말-것]] 섹션) — Jay Choi 와 Pocock 이 같은 진단의 두 처방을 내놓는다.
...
- [[concepts/design-concept]] — plan 자산보다 먼저 합의해야 할 것

## 출처

- [[sources/claude-code-2h-mastery]] — 입문편 "키보드 단축키", 실전편 "플랜 모드의 중요성"
- [[sources/jay-choi-9-tips]] — 플랜 적극 편집 + 명시적 지시 원칙
- [[sources/matt-pocock-software-fundamentals]] — *plan mode 가 자산을 너무 빨리 만든다* 비판 + grill me 대안
